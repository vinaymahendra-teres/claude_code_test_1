// Stroke-line icon set — 24x24 viewbox, 1.7 stroke.
// Ported verbatim from app/src/icons.jsx — match warm bakery feel: rounded joints, gentle.
...
const make = (path: ReactNode, opts: { fill?: string } = {}) => {
  const C = ({ size = 22, strokeWidth = 1.7, ...rest }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
...
export const Icon = {
  ...
  Star: make(<path d="M12 3l2.6 5.6 6.2.8-4.6 4.2 1.2 6L12 16.8 6.6 19.6l1.2-6L3.2 9.4l6.2-.8L12 3z" />),
  Heart: make(<path d="M12 20s-7-4.5-7-10a4 4 0 0 1 7-2.5A4 4 0 0 1 19 10c0 5.5-7 10-7 10z" />),
  Wallet: make(
    <>
  ...
  Trash: make(<path d="M4 7h16M9 7V4h6v3M6 7l1 13a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2l1-13" />),
  Truck: make(
    <>
  ...
  Egg: make(<path d="M12 3c-3 0-6 5-6 10a6 6 0 0 0 12 0c0-5-3-10-6-10z" />),
  Drop: make(<path d="M12 3s6 6.5 6 11a6 6 0 0 1-12 0c0-4.5 6-11 6-11z" />),
  Box: make(
    <>
